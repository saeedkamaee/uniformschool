# uniforms/models/prices/shirt_price.py
...
class AgreedShirtPrice(BaseModel):
    school = models.ForeignKey(
        School,
        on_delete=models.PROTECT,
        limit_choices_to={'gender': 'M'},  # فقط مدارس پسرانه
        related_name='shirt_prices',
        verbose_name="مدرسه"
    )
    ...
    def __str__(self):
        return f"پیراهن {self.size} - {self.school.name}: {self.agreed_amount:,} تومان"